...
public class Order {
    ...
    public Order(int orderID, User cusID, Date orderDate, double totalBill, int totalProduct, String orderAddress, Setting status, String note, String receive, ArrayList<OrderDetail> listProduct) {
