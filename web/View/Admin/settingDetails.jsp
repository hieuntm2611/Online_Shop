                                    ...
                                    <c:if test="${requestScope.mode == 'edit'}">
                                        <form action="SettingDetails" method="POST">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control mb-2" name ="group" placeholder="${requestScope.setting.group}"/>                                               
                                            </div>
                                            <div class="form-check">
                                                <label for="">Name:</label>
                                                <input type="text" class="form-control mb-2" name ="name" placeholder="${requestScope.setting.name}"/>                                              
                                            </div>
                                            <div class="form-check">
                                                <label for="">Order:</label>
                                                <input type="text" class="form-control mb-2" name ="order" placeholder="${requestScope.setting.order}"/>                                              
                                            </div>    
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">                 
                            <form action="SettingList" method="POST">
                                ...
                                <div class="form-check">
                                    <label for="">Type:</label>
                                    <input type="text" class="form-control mb-2" name ="group"/>                                               
                                </div>
                                <div class="form-check">
                                    <label for="">Value:</label>
                                    <input type="text" class="form-control mb-2" name ="type" />                                              
                                </div>
                                <div class="form-check">
                                    <label for="">Order:</label>
                                ...
                                <div class="form-check">
                                    ...
                                    <input type="text" class="form-control mb-2" name ="des"/>                                              
                                </div>    
