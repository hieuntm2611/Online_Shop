            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <c:forEach begin="0" end="${requestScope.sliders.size()}" var="i">
                            <c:if test="${i==0}">
                                <div class="carousel-item active">
                                    <a href="${requestScope.sliders[i].content}">
                                        <img src="View/imgslider/${requestScope.sliders[i].img}" alt="First slide" class="d-block w-100" >
                        ...
                        <div class="carousel-item">
                            <a href="Slide?sid=${requestScope.sliders[1].sliderID}">
                        ...
                        <div class="carousel-item">
                            <a href="Slide?sid=${requestScope.sliders[2].sliderID}">
                            ...
                            <c:forEach var="i" begin="0" end="5">                              
                                <div>
                                    <a class="btn btn-outline-secondary" 
                                       href="ProductList?service=search&keyword=${requestScope.keyword}
                                       &orderBy=1&sortBy=c&cateID=${st[i].settingID}&page=1">
                                        <div class="uk-card uk-card-default uk-card-body h-50 
                                             border border-secondary border-4 rounded text-center">
                                            <p class=" uk-position-center">${st[i].name}</p>
                                        </div>
                                    </a>
                                </div> 
                            </c:forEach>                   
